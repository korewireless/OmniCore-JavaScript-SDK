...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmniCoreModelAndStateManagementApi.ReplayBody();
  });
  ...
  describe('ReplayBody', function() {
    it('should create an instance of ReplayBody', function() {
      // uncomment below and update the code to test ReplayBody
      //var instance = new OmniCoreModelAndStateManagementApi.ReplayBody();
      //expect(instance).to.be.a(OmniCoreModelAndStateManagementApi.ReplayBody);
    });
