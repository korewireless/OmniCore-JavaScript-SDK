...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmniCoreModelAndStateManagementApi.AuditResult();
  });
  ...
  describe('AuditResult', function() {
    it('should create an instance of AuditResult', function() {
      // uncomment below and update the code to test AuditResult
      //var instance = new OmniCoreModelAndStateManagementApi.AuditResult();
      //expect(instance).to.be.a(OmniCoreModelAndStateManagementApi.AuditResult);
    });
