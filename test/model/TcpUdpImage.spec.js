...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmniCoreModelAndStateManagementApi.TcpUdpImage();
  });
  ...
  describe('TcpUdpImage', function() {
    it('should create an instance of TcpUdpImage', function() {
      // uncomment below and update the code to test TcpUdpImage
      //var instance = new OmniCoreModelAndStateManagementApi.TcpUdpImage();
      //expect(instance).to.be.a(OmniCoreModelAndStateManagementApi.TcpUdpImage);
    });
