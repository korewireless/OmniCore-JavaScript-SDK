...
(function(root, factory) {
  ...
  describe('MetricsData', function() {
    ...
    it('should have the property totalExports (base name: "TotalExports")', function() {
      // uncomment below and update the code to test the property totalExports
      //var instance = new OmniCoreModelAndStateManagementApi.MetricsData();
      //expect(instance).to.be();
    });

    it('should have the property totalReplays (base name: "TotalReplays")', function() {
      // uncomment below and update the code to test the property totalReplays
      //var instance = new OmniCoreModelAndStateManagementApi.MetricsData();
      //expect(instance).to.be();
    });
