...
(function(root, factory) {
  ...
  describe('Device', function() {
    ...
    it('should have the property tcpUdpModelDetails (base name: "tcpUdpModelDetails")', function() {
      // uncomment below and update the code to test the property tcpUdpModelDetails
      //var instance = new OmniCoreModelAndStateManagementApi.Device();
      //expect(instance).to.be();
    });

    it('should have the property tcpUdpModelId (base name: "tcpUdpModelId")', function() {
      // uncomment below and update the code to test the property tcpUdpModelId
      //var instance = new OmniCoreModelAndStateManagementApi.Device();
      //expect(instance).to.be();
    });

    it('should have the property isTcpUdpDevice (base name: "isTcpUdpDevice")', function() {
      // uncomment below and update the code to test the property isTcpUdpDevice
      //var instance = new OmniCoreModelAndStateManagementApi.Device();
      //expect(instance).to.be();
    });
