...
import TcpUdpModel from './TcpUdpModel';
...
class CustomOnboard {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tcpUdpModelDetails')) {
                obj['tcpUdpModelDetails'] = TcpUdpModel.constructFromObject(data['tcpUdpModelDetails']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['tcpUdpModelDetails']) { // data not null
          TcpUdpModel.validateJSON(data['tcpUdpModelDetails']);
        }
...
/**
 * @member {module:model/TcpUdpModel} tcpUdpModelDetails
 */
