...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.korewireless.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.korewireless.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.8.15/Javascript'
        };
    ...
    */
    hostSettings() {
        return [
            ...
            {
              'url': "https://demo.api.korewireless.com",
