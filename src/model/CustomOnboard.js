...
import CustomOnboardTcpUdpModelDetails from './CustomOnboardTcpUdpModelDetails';
...
class CustomOnboard {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tcpUdpModelDetails')) {
                obj['tcpUdpModelDetails'] = CustomOnboardTcpUdpModelDetails.constructFromObject(data['tcpUdpModelDetails']);
            }
            if (data.hasOwnProperty('tcpUdpModelId')) {
                obj['tcpUdpModelId'] = ApiClient.convertToType(data['tcpUdpModelId'], 'Number');
            }
            if (data.hasOwnProperty('isTcpUdpDevice')) {
                obj['isTcpUdpDevice'] = ApiClient.convertToType(data['isTcpUdpDevice'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `tcpUdpModelDetails`
        if (data['tcpUdpModelDetails']) { // data not null
          CustomOnboardTcpUdpModelDetails.validateJSON(data['tcpUdpModelDetails']);
        }
...
/**
 * @member {module:model/CustomOnboardTcpUdpModelDetails} tcpUdpModelDetails
 */
CustomOnboard.prototype['tcpUdpModelDetails'] = undefined;

/**
 * @member {Number} tcpUdpModelId
 */
CustomOnboard.prototype['tcpUdpModelId'] = undefined;

/**
 * @member {Boolean} isTcpUdpDevice
 */
CustomOnboard.prototype['isTcpUdpDevice'] = undefined;
