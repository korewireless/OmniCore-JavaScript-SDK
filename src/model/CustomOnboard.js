...
import ComponentsSchemasTcpUdpModel from './ComponentsSchemasTcpUdpModel';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tcpUdpModelDetails')) {
                obj['tcpUdpModelDetails'] = ApiClient.convertToType(data['tcpUdpModelDetails'], ComponentsSchemasTcpUdpModel);
            }
            if (data.hasOwnProperty('tcpUdpModelId')) {
                obj['tcpUdpModelId'] = ApiClient.convertToType(data['tcpUdpModelId'], Uint32);
            }
...
/**
 * @member {module:model/ComponentsSchemasTcpUdpModel} tcpUdpModelDetails
 */
CustomOnboard.prototype['tcpUdpModelDetails'] = undefined;

/**
 * @member {module:model/Uint32} tcpUdpModelId
 */
