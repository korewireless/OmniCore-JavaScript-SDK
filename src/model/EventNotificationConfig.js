...
class EventNotificationConfig {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vistaApiKey')) {
                obj['vistaApiKey'] = ApiClient.convertToType(data['vistaApiKey'], 'String');
            }
            if (data.hasOwnProperty('isVista')) {
                obj['isVista'] = ApiClient.convertToType(data['isVista'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['vistaApiKey'] && !(typeof data['vistaApiKey'] === 'string' || data['vistaApiKey'] instanceof String)) {
            throw new Error("Expected the field `vistaApiKey` to be a primitive type in the JSON string but got " + data['vistaApiKey']);
        }
 ...
 */
EventNotificationConfig.prototype['externalId'] = undefined;

/**
 * @member {String} vistaApiKey
 */
EventNotificationConfig.prototype['vistaApiKey'] = undefined;

/**
 * @member {Boolean} isVista
 */
EventNotificationConfig.prototype['isVista'] = undefined;
