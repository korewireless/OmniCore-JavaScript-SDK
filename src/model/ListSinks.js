...
import ListSinksSinksInner from './ListSinksSinksInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('sinks')) {
                obj['sinks'] = ApiClient.convertToType(data['sinks'], [ListSinksSinksInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        if (data['sinks']) { // data not null
            ...
            for (const item of data['sinks']) {
                ListSinksSinksInner.validateJsonObject(item);
            };
        }
...
/**
 * @member {Array.<module:model/ListSinksSinksInner>} sinks
 */
