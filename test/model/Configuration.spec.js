...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmniCoreModelAndStateManagementApi.Configuration();
  });
  ...
  describe('Configuration', function() {
    it('should create an instance of Configuration', function() {
      ...
      //var instance = new OmniCoreModelAndStateManagementApi.Configuration();
      //expect(instance).to.be.a(OmniCoreModelAndStateManagementApi.Configuration);
    });
