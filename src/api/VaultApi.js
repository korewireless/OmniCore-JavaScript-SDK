...
import EnableVault from '../model/EnableVault';
...
export default class VaultApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the enableVault operation.
     * @callback module:api/VaultApi~enableVaultCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Details} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionid Subscription ID
     * @param {Object} opts Optional parameters
     * @param {module:model/EnableVault} opts.enableVault application/json
     * @param {module:api/VaultApi~enableVaultCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Details}
     */
    enableVault(subscriptionid, opts, callback) {
      opts = opts || {};
      let postBody = opts['enableVault'];
      // verify the required parameter 'subscriptionid' is set
      if (subscriptionid === undefined || subscriptionid === null) {
        throw new Error("Missing the required parameter 'subscriptionid' when calling enableVault");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = Details;
      return this.apiClient.callApi(
        '/vault/subscriptions/{subscriptionid}/enable-vault', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
