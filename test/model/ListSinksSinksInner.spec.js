...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmniCoreModelAndStateManagementApi.ListSinksSinksInner();
  });
  ...
  describe('ListSinksSinksInner', function() {
    it('should create an instance of ListSinksSinksInner', function() {
      // uncomment below and update the code to test ListSinksSinksInner
      //var instance = new OmniCoreModelAndStateManagementApi.ListSinksSinksInner();
      //expect(instance).to.be.a(OmniCoreModelAndStateManagementApi.ListSinksSinksInner);
    });
