...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmniCoreModelAndStateManagementApi.Folder();
  });
  ...
  describe('Folder', function() {
    it('should create an instance of Folder', function() {
      ...
      //var instance = new OmniCoreModelAndStateManagementApi.Folder();
      //expect(instance).to.be.a(OmniCoreModelAndStateManagementApi.Folder);
    });
