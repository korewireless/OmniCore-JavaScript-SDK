...
/**
 * The ListSinksSinksInner model module.
 * @module model/ListSinksSinksInner
 * @version 1.0
 */
class ListSinksSinksInner {
    /**
     * Constructs a new <code>ListSinksSinksInner</code>.
     * @alias module:model/ListSinksSinksInner
     */
    constructor() { 
        
        ListSinksSinksInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSinksSinksInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSinksSinksInner} obj Optional instance to populate.
     * @return {module:model/ListSinksSinksInner} The populated <code>ListSinksSinksInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSinksSinksInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ListSinksSinksInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSinksSinksInner</code>.
     */
 ...
 * @member {String} id
 */
ListSinksSinksInner.prototype['id'] = undefined;

/**
 * @member {String} subscription
 */
ListSinksSinksInner.prototype['subscription'] = undefined;

/**
 * @member {module:model/ListSinksSinksInner.SinkEnum} sink
 */
ListSinksSinksInner.prototype['sink'] = undefined;

/**
 * @member {module:model/ListSinksSinksInnerConfig} config
 */
ListSinksSinksInner.prototype['config'] = undefined;

/**
 * @member {Boolean} status
 */
ListSinksSinksInner.prototype['status'] = undefined;

/**
 * @member {String} createdon
 */
ListSinksSinksInner.prototype['createdon'] = undefined;

/**
 * @member {String} updatedon
 */
ListSinksSinksInner.prototype['updatedon'] = undefined;
...
export default ListSinksSinksInner;
