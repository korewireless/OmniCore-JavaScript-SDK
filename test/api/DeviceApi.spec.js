...
(function(root, factory) {
  ...
  describe('DeviceApi', function() {
    ...
    describe('getDevicesLastSeen', function() {
      it('should call getDevicesLastSeen successfully', function(done) {
        //uncomment below and update the code to test getDevicesLastSeen
        //instance.getDevicesLastSeen(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
