...
(function(root, factory) {
  ...
  describe('DeviceApi', function() {
    ...
    describe('getSubscriptionDevices', function() {
      it('should call getSubscriptionDevices successfully', function(done) {
        //uncomment below and update the code to test getSubscriptionDevices
        //instance.getSubscriptionDevices(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
